  ...
  <div class="avatar-cropper">
    <div class="avatar-canvas">
      <canvas
        ...
        :width="canvasWidth"
        :height="canvasHeight"
        v-finger:options="options"
        @touchend="reset"></canvas>
        <div
          class="mask"
          :style="{
            width:  cutWidth+'px',
    ...
    <div style="display: none;">
      <canvas
        ...
        ref="canvas_dp"
        :height="cutHeight"
        :width="cutWidth"></canvas>
    </div>

    <div class="foot-btns">
      <span class="left" @click="cancel">取消</span>
      <span class="right" @click="getImage">完成</span>
    </div>
</div>
...
<script>
  /* eslint-disable */
  import Vue from 'vue'
  import VueFinger from '../lib/finger2.js'
  ...
  export default {
    ...
    methods: {
      ...
      getImage: function () {
        ...
        self.$store.dispatch('previewImg', im)
        self.$router.push({path: '/home'})
        // this.$refs.canvas_dp.toBlob(function (blob) {

        //   photoOptions.handler(im)
        // }, 'image/jpeg', 1)
    ...
    computed: {
      ...
      photoOptions () {
        return this.$store.state.photoOptions
      }
    },
    mounted () {
      (function () {
      ...
      this.canvas2 = this.$refs.canvas_dp
